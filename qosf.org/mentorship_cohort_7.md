...
# Hero section
title: "ARCHIVED: Quantum Computing Mentorship Program Cohort Seven Showcase"
description: "Showcase of projects from the seventh cohort of our Quantum Computing Mentorship program. (Cohort concluded)"
buttons:
...
<div style="background-color: #ffcccb; padding: 15px; border: 1px solid #ff726f; border-radius: 5px; margin-bottom: 20px;">
  <strong>ARCHIVED CONTENT:</strong> This page describes projects from Cohort 7 of the Mentorship Program, which has concluded. The information below is for historical purposes. For information on current mentorship opportunities, please visit our <a href="/qc_mentorship">main mentorship page</a>.
</div>
