...
# Hero section
title: "ARCHIVED: Quantum Computing Mentorship Program Cohort Nine Showcase"
description: "Showcase of projects from the ninth cohort of our Quantum Computing Mentorship program. (Cohort concluded)"
buttons:
...
permalink: /mentorship_cohort_9/

---

<div style="background-color: #ffcccb; padding: 15px; border: 1px solid #ff726f; border-radius: 5px; margin-bottom: 20px;">
  <strong>ARCHIVED CONTENT:</strong> This page describes projects from Cohort 9 of the Mentorship Program, which has concluded. The information below is for historical purposes. For information on current mentorship opportunities, please visit our <a href="/qc_mentorship">main mentorship page</a>.
</div>

## Quantum Mentorship Program Cohort 9 Project Showcase 
