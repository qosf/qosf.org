...
# Run nbgrader to generate feedback for the assignment
nbgrader generate_feedback "$ASSIGNMENT_NAME"

# Return to the previous directory
cd "$CURRENT_DIR" || { echo "Failed to return to directory '$CURRENT_DIR'"; exit 1; }

echo "Feedback has been generated for assignment '$ASSIGNMENT_NAME' in course '$COURSE_NAME' successfully."
