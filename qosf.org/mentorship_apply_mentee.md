...
keywords: QOSF mentorship application, mentee application, quantum computing mentorship
comments: false
eyebrow: Mentee application
title: Apply as a mentee
description: Tell us about your background and interests. We use this to match you with a mentor whose expertise and timezone fit yours.
buttons:
...
<form id="mentorship-form" class="mentorship-form" novalidate>
  ...
  <div class="form-row">
    <label for="level">Education / professional level <span class="req">*</span></label>
    <select id="level" name="level" required>
      <option value="">Select...</option>
      <option value="1">High school / pre-university</option>
  ...
  <div class="form-row">
    <label>Research interests <span class="req">*</span></label>
    <div class="hint">Select all that apply - used to match you with a mentor.</div>
  ...
  <div class="form-row">
    ...
    <input type="number" id="availability" name="availability" min="1" max="40" required>
    <div class="hint">Projects typically take 6-8 hours per week.</div>
  </div>
  ...
  <div class="form-row">
    ...
    <textarea id="motivation" name="motivation" required placeholder="A few sentences about your goals and background."></textarea>
  </div>
